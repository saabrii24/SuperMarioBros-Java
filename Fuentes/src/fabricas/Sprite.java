...
public class Sprite {
    ...
    // Getters
    public String get_ruta_imagen() { return ruta_a_imagen; }
    public int get_ancho() { return ancho; }
    public int get_alto() { return alto; }
    
    // Setters
    public void set_alto(int nuevo_alto) { alto = nuevo_alto; }
    public void set_ancho(int nuevo_ancho) { ancho = nuevo_ancho; }
